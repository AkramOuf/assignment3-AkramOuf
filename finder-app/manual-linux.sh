...
ARCH=arm64
export PATH="$PATH:/home/akram/Public/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-linux-gnu/bin"
...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    if [ -e ${OUTDIR}/linux-stable/.config ]; then 
...
mkdir -p rootfs
cd rootfs
mkdir -p bin dev etc home lib lib64 proc sys sbin tmp var usr
